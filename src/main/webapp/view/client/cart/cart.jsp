...
<html lang="en">
  <head>
    ...
    <link href="${pageContext.request.contextPath}/resources/client/css/bootstrap.min.css"
	rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="${pageContext.request.contextPath}/resources/client/css/style.css"
	rel="stylesheet">
  </head>
        ...
        <div class="d-flex justify-content-between">
          <div class="top-info ps-2">
            <small class="me-3"
              ...
              <a href="#" class="text-white">Đình Quán, Hà Nội</a></small
            >
            <small class="me-3"
          ...
          <div class="top-link pe-2">
            <a href="#" class="text-white"
              ><small class="text-white mx-2">Chính sách bảo mật</small>/</a
            >
            <a href="#" class="text-white"
              ><small class="text-white mx-2">Điều khoản sử dụng</small>/</a
            >
            <a href="#" class="text-white"
              ><small class="text-white ms-2">Bán hàng và hoàn tiền</small></a
            >
          </div>
        </div>
      </div>
      <div class="container px-0">
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
          <a href="index.html" class="navbar-brand"
            ><h1 class="text-primary display-6">Steamen</h1></a
          >
          <button
            ...
            <tbody>
              <tr>
                <th scope="row">
                  <div class="d-flex align-items-center">
                    <img
                      src="../../../resources/images/somia2.jpg"
                ...
                <td>
                  <p class="mb-0 mt-4">Áo sơ mi</p>
                </td>
                </td>
                <td>
                  <p class="mb-0 mt-4">100.000đ</p>
                </td>
                <td>
              ...
              <tr>
                <th scope="row">
                  <div class="d-flex align-items-center">
                    <img
                      src="../../../resources/images/somif3.jpg"
                      class="img-fluid me-5 rounded-circle"
                      style="width: 80px; height: 80px"
                      alt=""
                      alt=""
                ...
                <td>
                  <p class="mb-0 mt-4">Áo phông</p>
                </td>
                <td>
                  <p class="mb-0 mt-4">300.000đ</p>
                </td>
                <td>
                  <div class="input-group quantity mt-4" style="width: 100px">
                    <div class="input-group-btn">
              ...
              <tr>
                ...
                <td>
                  <p class="mb-0 mt-4">Quần jean</p>
                </td>
                <td>
                  <p class="mb-0 mt-4">200.000đ</p>
                </td>
                <td>
                  <div class="input-group quantity mt-4" style="width: 100px">
                    <div class="input-group-btn">
            ...
            <div class="bg-light rounded">
              <div class="p-4">
                ...
                <div class="d-flex justify-content-between mb-4">
                  ...
                  <p class="mb-0">600.000đ</p>
                </div>
                <div class="d-flex justify-content-between">
                  <h5 class="mb-0 me-4">Vận chuyển</h5>
                  <div class="">
                    <p class="mb-0">Phí vận chuyển: 0đ</p>
                  </div>
                </div>
                <p class="mb-0 text-end">Tới Đình Quán.</p>
              </div>
              <div
                class="py-4 mb-4 border-top border-bottom d-flex justify-content-between"
              >
                <h5 class="mb-0 ps-4 me-4">Tổng cộng</h5>
                <p class="mb-0 pe-4">600.000đ</p>
              </div>
              <button
      ...
      <div class="container py-5">
        ...
        >
          <div class="row g-4">
            <div class="col-lg-3">
              <a href="#">
                <h1 class="text-primary mb-0">Steamen</h1>
